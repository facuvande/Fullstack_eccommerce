...
export const FooterNav = ({changeSeccion}) => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-slate-950 dark:border-gray-600">
            <div className={isUserAdmin ? "grid h-full max-w-lg grid-cols-5 mx-auto font-medium" : "grid h-full max-w-lg grid-cols-4 mx-auto font-medium"}>
                ...
                {
                    !isUserAdmin && <button type="button" onClick={() => changeSeccion('cart')} className="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
